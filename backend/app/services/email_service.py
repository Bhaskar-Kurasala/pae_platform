...
class EmailService:
    ...
    async def send_progress_digest(
        ...
        Args:
            stats: dict with keys ``lessons_completed``, ``skills_touched``,
                   ``streak_days``, ``top_concept``.
        """
    ...
    async def send_weekly_letter(
        ...
        The body is a markdown letter generated by the progress_report agent —
        tone is warm-coach, evidence over praise, no loss-aversion copy.
        """
