...
Follow-up file rename: at D11 Checkpoint 4 cutover this becomes
backend/app/agents/senior_engineer.py (the legacy file with the same
name is deleted at the same commit).
"""
...
log = structlog.get_logger().bind(layer="senior_engineer_v2")
