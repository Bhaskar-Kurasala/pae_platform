"""Standalone runner for 3B #5 weekly-hours helper."""
...
MODULE = BACKEND / "app" / "services" / "goal_contract_service.py"
TESTS = BACKEND / "tests" / "test_services" / "test_goal_contract_weekly_hours.py"

PURE_FUNCS = {"daily_minutes_target"}
PURE_CONSTS = {"_WEEKLY_HOURS_TO_DAILY_MINUTES"}
...
def main() -> int:
    ...
    test_ns: dict[str, object] = {
        "daily_minutes_target": ns["daily_minutes_target"],
    }
