"""Standalone runner for 3B #101 peer-review helpers."""
...
MODULE = BACKEND / "app" / "services" / "peer_review_service.py"
TESTS = BACKEND / "tests" / "test_services" / "test_peer_review_service.py"

PURE_FUNCS = {"pick_reviewers", "validate_review"}
PURE_CONSTS = {
    "_MAX_REVIEWERS_PER_SUBMISSION",
    "_MIN_RATING",
    "_MAX_RATING",
    "_MAX_COMMENT_LEN",
}
...
def main() -> int:
    ...
    test_ns: dict[str, object] = {
        "pick_reviewers": ns["pick_reviewers"],
        "validate_review": ns["validate_review"],
    }
