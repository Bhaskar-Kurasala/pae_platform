...
- The agent-call-failed branch's `verdict_reasoning` may be longer than the row's 2000-char column. Today it's truncated by the writer's existing `[:2000]` slice, but the truncation is silent.
...
None of this blocks D13 ship. D17 cleanup item.
