...
>
> **🚀 Building the retention engine?** See [`RETENTION-ENGINE.md`](./RETENTION-ENGINE.md). 14 tickets (F1-F14) for turning `/admin/*` from a static dashboard into an active system that catches students before they slip out — student risk scoring, admin notes, outreach log, real console panels, email service, six slip-pattern templates. Tier 1 is launch-blocking.
